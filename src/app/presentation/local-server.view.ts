    ...
    constructor() {
        this.children = [
            ...
            { class: 'my-3' },
            {
                class: 'text',
                innerHTML:
                    'The <a href="">W3Swarm</a> Python package allows you to emulate the entire W3Swarm environment on ' +
                    ...
                    'These make it a perfect fit for developers to easily publish their code within W3Swarm remote ' +
                    'instance(s).',
            },
        ]
    }
