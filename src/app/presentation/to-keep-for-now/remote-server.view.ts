    ...
    constructor() {
        this.children = [
            ...
            { class: 'my-3' },
            {
                class: 'text',
                innerHTML:
                    'WebPM can also be installed as a Helm chart in your K8s cluster. Similar to the python ' +
                    ...
                    'New WebPM instances are backed up automatically & lazily by the public instance, ' +
