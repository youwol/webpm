    ...
    constructor() {
        this.children = [
            ...
            { class: 'my-3' },
            {
                class: 'text',
                innerHTML:
                    'W3Swarm can also be installed as a Helm chart in your K8s cluster. Similar to the python ' +
                    ...
                    'New W3Swarm instances are backed up automatically & lazily by the public instance, ' +
